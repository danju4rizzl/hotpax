...
function LockGate({
  ...
  return /* @__PURE__ */ jsxs("div", { style: styles.root, children: [
    ...
    /* @__PURE__ */ jsxs("div", { style: styles.card, children: [
      /* @__PURE__ */ jsxs("div", { style: styles.iconWrap, children: [
        /* @__PURE__ */ jsxs("div", { style: styles.iconBox, children: [
          /* @__PURE__ */ jsx(Lock, { style: { width: "2rem", height: "2rem", color: "#181c1e" }, strokeWidth: 1.8 }),
          /* @__PURE__ */ jsx("div", { style: styles.clockBadge, children: /* @__PURE__ */ jsx(Clock, { style: { width: "0.875rem", height: "0.875rem", color: "#181c1e" }, strokeWidth: 2 }) })
        ] }),
        /* @__PURE__ */ jsxs("div", { style: styles.badge, children: [
          /* @__PURE__ */ jsx("span", { style: styles.pulseDot }),
          "Access Blocked"
        ] })
      ] }),
      /* @__PURE__ */ jsxs("h1", { style: styles.heading, children: [
        "This website is",
        /* @__PURE__ */ jsx("br", {}),
        "Temporarily Offline"
      ] }),
      /* @__PURE__ */ jsx("div", { style: styles.divider }),
      /* @__PURE__ */ jsxs("p", { style: styles.description, children: [
        "Access to the",
        " ",
        /* @__PURE__ */ jsxs("span", { style: styles.siteName, children: [
          siteName,
          " "
        ] }),
        "is currently restricted. Please contact your administrator or developer for more information."
      ] }),
      (supportEmail || supportUrl) && /* @__PURE__ */ jsxs("div", { style: styles.buttons, children: [
    ...
    /* @__PURE__ */ jsx("div", { style: styles.footer, children: /* @__PURE__ */ jsxs("div", { style: styles.footerText, children: [
